...
import { p as parseURL, l as encodePath, m as decodePath, c as createError$1, n as hasProtocol, o as isScriptProtocol, i as joinURL, w as withQuery, s as sanitizeStatusCode, q as getContext, $ as $fetch, r as executeAsync, t as defu } from '../nitro/nitro.mjs';
...
const _routes = [
  {
    name: "index",
    path: "/",
    component: () => import('./index-BwTJ4ot0.mjs')
  }
];
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import('./error-404-DXT3RAGQ.mjs'));
    const _Error = defineAsyncComponent(() => import('./error-500-DqR1FPXR.mjs'));
