...
const styles = {
  ...
  "components/Modal.vue": () => import('./Modal-styles.B--lNLT_.mjs').then(interopDefault),
  "components/Modal.vue?vue&type=style&index=0&scoped=2de0ef94&lang.css": () => import('./Modal-styles.B--lNLT_.mjs').then(interopDefault)
};
