...
const appHead = {"meta":[{"name":"viewport","content":"width=device-width, initial-scale=1"},{"charset":"utf-8"},{"name":"description","content":"Ayo gacha untuk menemukan kata-kata para tokoh diseluruh dunia"},{"name":"format-detection","content":"telephone=no"}],"link":[{"rel":"icon","type":"image/x-icon","href":"/favicon.ico"}],"style":[],"script":[],"noscript":[],"title":"Gachakata","charset":"utf-8","viewport":"width=device-width, initial-scale=1"};
